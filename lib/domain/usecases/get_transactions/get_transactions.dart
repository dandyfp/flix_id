...
import 'package:flix_id/domain/usecases/get_transactions/get_transactions_parama.dart';
import 'package:flix_id/domain/usecases/usecase.dart';

class GetTransactions implements UseCase<Result<List<Transaction>>, GetTransitionParam> {
  ...
  @override
  Future<Result<List<Transaction>>> call(GetTransitionParam params) async {
